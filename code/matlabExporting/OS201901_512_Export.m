...
EVFilePath = 'E:\ChukchiTimeSeries\data\acousticData\2017_2019\EV\2019\echoview\';  

%  define the output file path
%ExportFileBase = 'E:\ChukchiTimeSeries\data\acousticData\2017_2019\EV\2019\echoview\exports\1m\';   
ExportFileBase = 'E:\ChukchiTimeSeries\data\acousticData\2017_2019\EV\2019\echoview\exports\5m\';   

%set .ecs file (calibration file) to use.
%ECSfilename = 'G:\DY1502\calibration\DY1502postcal.ecs';
ECSfilename = 'E:\ChukchiTimeSeries\data\acousticData\2017_2019\EV\2019\calibration\Ocean_Starr_2019_MB2_512.ecs';
...
Variable_for_export  = 'Fish (smoothed)';  
...
%layer_thickness = 1; %5, 5 for analysis/MB2, 1 for vert. %surface-reference layer thickness, typically 10 m,
layer_thickness = 5; %  5 for analysis/MB2, 1 for vert. %surface-reference layer thickness, typically 10 m,
EDSU_length = 0.5;  %typically 0.5 nmi

% Update raw file path
newRawFiles = 0;
rawDir = 'D:\AIESII\OS201901\EK60_Data';
