%   
%  EXPORT ZOOPLANKTON FROM FISH REGIONS IN 2017, AS WAS DONE IN 2012/2013
%
...
EVFilePath = 'D:\AIESII\OceanStarr_201701_AIERP\Echoview\';  

%  define the output file path
ExportFileBase = 'D:\AIESII\OceanStarr_201701_AIERP\Echoview\Zp\exports\5m_FishRegions\';   

%set .ecs file (calibration file) to use.
%ECSfilename = 'G:\DY1502\calibration\DY1502postcal.ecs';
ECSfilename = 'D:\AIESII\OceanStarr_201701_AIERP\calibration\Ocean_Starr_2017_Final_settings_512msPL.ecs';
...
Variable_for_export  = 'Zp (smoothed)';  

%  define the thresholds
minimum_integration_threshold = -80;  %typically -70 dB Sv 
maximum_integration_threshold = -20;  %an Sv of 0 dB seems reasonable
...
%  elements and so on.
exclude_above_line_name_38= '38 kHz surfturb line';
exclude_above_line_name= {'120 kHz surfturb line'};
...
for i = 1:size(files,1);
    ...
    % set the 120 kHz surfturb line as a 4m offset from the 38 kHz line
    EvLine = EvFile.Lines.FindByName(exclude_above_line_name_38);
    EvNewLine = EvFile.Lines.CreateOffsetLinear(EvLine,1,4,1);
    EvLineOld = EvFile.Lines.FindByName(exclude_above_line_name{1});
